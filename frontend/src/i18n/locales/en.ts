export default {
  ...
  common: {
    ...
    scanToContact: 'Scan QR to Contact',
    scanToJoin: 'Scan QR to Join Group',
    add: 'Add',
  ...
  admin: {
    ...
    proxies: {
      ...
      batchInputPlaceholder:
        'Enter one proxy per line in the following formats:\nsocks5://user:pass(at)192.168.1.1:1080\nhttp://192.168.1.1:8080\nhttps://user:pass(at)proxy.example.com:443',
      batchInputHint:
        'Supports http, https, socks5 protocols. Format: protocol://[user:pass(at)]host:port',
    ...
    site: {
      ...
      smtp: {
        ...
        usernamePlaceholder: 'your-email(at)gmail.com',
        ...
        fromEmailPlaceholder: 'noreply(at)example.com',
        fromName: 'From Name',
      ...
      testEmail: {
        ...
        recipientEmailPlaceholder: 'test(at)example.com',
