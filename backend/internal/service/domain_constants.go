...
const (
	...
	AdjustmentTypeInviteReward     = domain.AdjustmentTypeInviteReward     // 邀请奖励
)

// Invite status constants
const (
	InviteStatusPending   = domain.InviteStatusPending
	InviteStatusConfirmed = domain.InviteStatusConfirmed
)

// Invite log action constants
const (
	InviteLogActionBind    = domain.InviteLogActionBind
	InviteLogActionConfirm = domain.InviteLogActionConfirm
)
...
const (
	...
	SettingKeyInviteRewardAmount = "invite_reward_amount" // 邀请奖励额度
