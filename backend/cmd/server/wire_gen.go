...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	adminPlanHandler := admin.NewPlanHandler(planService)
	uploadService := service.NewUploadService()
	uploadHandler := admin.NewUploadHandler(uploadService)
	...
	adminInviteHandler := admin.NewInviteHandler(inviteService)
