...
func (_q *InvitationQuery) QueryInviter() *UserQuery {
...
func (_q *InvitationQuery) QueryInvitee() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *InvitationQuery) QueryConfirmedByUser() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *InvitationQuery) QueryLogs() *InviteLogQuery {
...
func (_q *InvitationQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *InvitationQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *InvitationQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *InvitationQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *InvitationQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *InvitationQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *InvitationQuery) WithInviter(opts ...func(*UserQuery)) *InvitationQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *InvitationQuery) WithInvitee(opts ...func(*UserQuery)) *InvitationQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *InvitationQuery) WithConfirmedByUser(opts ...func(*UserQuery)) *InvitationQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *InvitationQuery) WithLogs(opts ...func(*InviteLogQuery)) *InvitationQuery {
	query := (&InviteLogClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(invitation.FieldInviterID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Invitation.Query().
//		Select(invitation.FieldInviterID).
//		Scan(ctx, &v)
...
func (_q *InvitationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Invitation, error) {
	...
	if query := _q.withInvitee; query != nil {
		if err := _q.loadInvitee(ctx, query, nodes, nil,
			func(n *Invitation, e *User) { n.Edges.Invitee = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withConfirmedByUser; query != nil {
		if err := _q.loadConfirmedByUser(ctx, query, nodes, nil,
			func(n *Invitation, e *User) { n.Edges.ConfirmedByUser = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withLogs; query != nil {
		if err := _q.loadLogs(ctx, query, nodes,
			func(n *Invitation) { n.Edges.Logs = []*InviteLog{} },
			func(n *Invitation, e *InviteLog) { n.Edges.Logs = append(n.Edges.Logs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *InvitationQuery) loadInviter(ctx context.Context, query *UserQuery, nodes []*Invitation, init func(*Invitation), assign func(*Invitation, *User)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Invitation)
	for i := range nodes {
...
func (_q *InvitationQuery) loadInvitee(ctx context.Context, query *UserQuery, nodes []*Invitation, init func(*Invitation), assign func(*Invitation, *User)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Invitation)
	for i := range nodes {
...
func (_q *InvitationQuery) loadConfirmedByUser(ctx context.Context, query *UserQuery, nodes []*Invitation, init func(*Invitation), assign func(*Invitation, *User)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Invitation)
	for i := range nodes {
...
func (_q *InvitationQuery) loadLogs(ctx context.Context, query *InviteLogQuery, nodes []*Invitation, init func(*Invitation), assign func(*Invitation, *InviteLog)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(invitelog.FieldInviteID)
	}
	query.Where(predicate.InviteLog(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(invitation.LogsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *InvitationQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(invitation.Table, invitation.Columns, sqlgraph.NewFieldSpec(invitation.FieldID, field.TypeInt64))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withInviter != nil {
			_spec.Node.AddColumnOnce(invitation.FieldInviterID)
		}
		if _q.withInvitee != nil {
			_spec.Node.AddColumnOnce(invitation.FieldInviteeID)
		}
		if _q.withConfirmedByUser != nil {
			_spec.Node.AddColumnOnce(invitation.FieldConfirmedBy)
		}
	}
...
func (_q *InvitationQuery) ForUpdate(opts ...sql.LockOption) *InvitationQuery {
...
func (_q *InvitationQuery) ForShare(opts ...sql.LockOption) *InvitationQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
